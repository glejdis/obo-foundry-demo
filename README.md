...
Two OBO variants — diagrams generated by
[docs/diagrams/build_diagrams.py](docs/diagrams/build_diagrams.py)
(`python docs/diagrams/build_diagrams.py`, needs `matplotlib`):
